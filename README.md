...
3. **Guía motivacional** — Al presionar "Comenzar", reproduce 5 audios motivacionales (task_started, good_job, keep_going, almost_done, all_done) con pausas de 10s entre cada uno.
